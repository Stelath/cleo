...
from generated import transcription_pb2 as transcription__pb2
...
class TranscriptionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TranscribeStream = channel.stream_stream(
                '/cleo.transcription.TranscriptionService/TranscribeStream',
                request_serializer=transcription__pb2.AudioInput.SerializeToString,
                response_deserializer=transcription__pb2.TranscriptionResult.FromString,
                _registered_method=True)
        self.Transcribe = channel.unary_unary(
                '/cleo.transcription.TranscriptionService/Transcribe',
                request_serializer=transcription__pb2.AudioInput.SerializeToString,
                response_deserializer=transcription__pb2.TranscriptionResult.FromString,
                _registered_method=True)
...
def add_TranscriptionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TranscribeStream': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=transcription__pb2.AudioInput.FromString,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'cleo.transcription.TranscriptionService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cleo.transcription.TranscriptionService', rpc_method_handlers)
...
class TranscriptionService(object):
    ...
    def TranscribeStream(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/cleo.transcription.TranscriptionService/TranscribeStream',
            transcription__pb2.AudioInput.SerializeToString,
